...
{
    public class AsiakkaanperustiedotController : Controller
    {
        private tuotantoEntities db = new tuotantoEntities();

        // GET: Asiakkaanperustiedot
        public ActionResult Index()
        {
            return View(db.Asiakkaanperustiedot.ToList());
        }

        // GET: Asiakkaanperustiedot/Details/5
        ...
        // GET: Asiakkaanperustiedot/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Asiakkaanperustiedot/Create
        ...
        // GET: Asiakkaanperustiedot/Edit/5
        ...
        // POST: Asiakkaanperustiedot/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Asiakkaanperustiedot/Delete/5
        ...
        // POST: Asiakkaanperustiedot/Delete/5
